...
static void kvm_set_devirt(Object *obj, Visitor *v,
                                   const char *name, void *opaque,
                                   Error **errp)
{
    KVMState *s = KVM_STATE(obj);
...
static void kvm_accel_class_init(ObjectClass *oc, void *data)
{
    ...
    object_class_property_add(oc, "devirt", "on|off",
        NULL, kvm_set_devirt, NULL, NULL);
    object_class_property_set_description(oc, "devirt",
        "Configure KVM devirt support");
