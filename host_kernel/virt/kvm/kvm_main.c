 ...
 */
void __weak kvm_mmu_devirt_create(struct kvm *kvm)
{ }

void __weak kvm_mmu_devirt_destroy(struct kvm *kvm)
{ }
			   ...
			   unsigned int ioctl, unsigned long arg)
{
	...
	case KVM_CREATE_MAPPING: {
		kvm_mmu_devirt_create(kvm);
		break;
	}
