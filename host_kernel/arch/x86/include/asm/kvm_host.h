...
struct kvm_vcpu_arch {
	...
	/*
	 * Stores the cr3 which the guest thinks it has set.
	 * While this value != 0 devirt is active:
	 * 	return this on cr3 reads
	 * 	capture cr3 reads to return this value
	 */
	unsigned long devirt_user_cr3;
...
struct kvm_x86_ops {
	...
	void (*set_cr3_exit)(struct kvm_vcpu *vcpu, bool do_exit);
	void (*set_ept)(struct kvm_vcpu *vcpu, bool enable_ept);
	void (*sec_exec_devirt)(struct kvm_vcpu *vcpu);
