...
struct pv_mmu_ops {
	...
	int (*ptep_set_access_flags)(unsigned long address,
	...
	pte_t (*ptep_get_and_clear)(struct mm_struct *mm, unsigned long addr,
			pte_t *ptep);
	void (*ptep_set_wrprotect)(struct mm_struct *mm, unsigned long addr,
			pte_t *ptep);
	int (*pmdp_set_access_flags)(unsigned long address,
			pmd_t *pmdp, pmd_t entry, int dirty);
	int (*pudp_set_access_flags)(unsigned long address,
	...
	pmd_t (*pmdp_huge_get_and_clear)(struct mm_struct *mm, unsigned long addr,
			pmd_t *pmdp);
	pud_t (*pudp_huge_get_and_clear)(struct mm_struct *mm, unsigned long addr,
			pud_t *pudp);
	void (*pmdp_set_wrprotect)(struct mm_struct *mm, unsigned long addr,
			pmd_t *pmdp);
